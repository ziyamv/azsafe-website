...
export default function HomePage() {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      titleAz: <><span>Satış sonrası servis</span><span className="block mt-4">və avadanlıqlara xidmət</span></>,
      titleEn: <><span>After-Sales Service &</span><span className="block mt-4">Equipment Maintenance</span></>,
